...
public class Movement {
    public static void moveThePawn(GridPane grid, Pawn pawn, int diceRoll, UserMovesList list, List<Field> mapOfMovements) {
        List<Field> movementList = mapOfMovements;
